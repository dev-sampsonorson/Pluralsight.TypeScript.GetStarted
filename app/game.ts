...
export class Game {
    ...
    constructor(public player: Player, public problemCount: number, public factor: number) { // can use public, protected, private, readonly
    ...
    calculateScore(): void {
        ...
        // loop through the text boxes and calulate the number that are correct
        for (let i = 1; i <= this.problemCount; i++) {
